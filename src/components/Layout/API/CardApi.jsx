  ...
  return (
    <div className=" ">
      <div className="max-w-sm rounded overflow-hidden ">
        <div className="relative overflow-hidden w-full py-22 px-22 h-full">
          ...
          <div className="grid grid-cols-1 absolute  top-0 right-0">
            <button
              ...
              className="md:h-8  w-6 md:w-8 rounded-full bg-neutral-100 flex items-center justify-center hover:bg-slate-200 text-sm md:text-xl pt-1 mr-2 mt-2"
            >
              <span>
                <ion-icon
                  name="heart-outline"
          ...
          />
          <div className="absolute h-[60%] md:h-[37%] w-full bg-black flex items-center justify-center mb-5 text-start -bottom-12 group-hover:bottom-0  opacity-0 hover:opacity-100 transition-all duration-300 pb-5">
            <button
              onClick={props.onClick}
              className="bg-black text-white py-2 md:py-4 px-5 font-medium  text-sm md:text-lgfont-medium"
            >
              Add to cart
            </button>
          </div>
        ...
        <div className="px-3 py-4">
          <div className="font-medium   text-sm lg:text-xl mb-2">
            {props.name}
          </div>
